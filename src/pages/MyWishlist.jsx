...
const MyWishlist = () => {
  ...
  return (
    <>
      <div>
        <Helmet>
          <title>My Wishlist | OnceTicket</title>
        </Helmet>
      </div>
      <div className='bg-[#F4F7FF]'>
        ...
        <main className='flex'>
          ...
          <div className='p-8 w-full'>
            <div className='flex flex-col bg-white px-9 lg:px-12 py-9 lg:py-11 rounded-2xl md:min-h-[650px]'>
              ...
              <div>
                {myWishlist.length < 1 && (
                  <div className=' h-full flex flex-col items-center justify-center gap-7 '>
                    <div className='font-semibold text-2xl'>No Wishlist Found</div>
