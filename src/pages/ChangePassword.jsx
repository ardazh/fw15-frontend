                    ...
                    <div className="bg-white px-12 py-11 rounded-2xl mr-16 h-[750px]">
                        ...
                        <form className="flex flex-col gap-8">
                            <div className="flex items-center gap-16">
                                <label className="w-40" for="old-password">Old Password</label>
                            ...
                            <div className="flex items-center gap-16">
                                <label className="w-40" for="old-password">New Password</label>
                            ...
                            <div className="flex items-center gap-16">
                                <label className="w-40" for="old-password">Confirm Password</label>
